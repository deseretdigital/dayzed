...
describe('Single', () => {
  ...
  it('Toggling Adjacent Months Works', () => {
    ...
    cy
      ...
      .last()
      .should('be.empty');
    // Toogle adjacent months.
    cy.getInStoryByTestId('fillAdjacentMonthsButton').click();
    cy.getInStoryByTestId('firstDayOfWeek').should('contain', 'Mon');
    // First of month.
    let firstChild = cy
      .getInStoryByTestId('calendarDates')
    ...
    cy
      .getInStoryByTestId('dateSelected')
      .should('contain', prevMonthDate.toLocaleDateString());
    // Last of month.
    let lastChild = () =>
      cy
        .getInStoryByTestId('calendarDates')
    ...
    cy
      .getInStoryByTestId('dateSelected')
      .should('contain', nextMonthDate.toLocaleDateString());
